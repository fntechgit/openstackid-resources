    ...
    public static function build(array $data, $update = false){
        if($update){
            return [
                ...
                'sales_start_date'        => 'sometimes|date_format:U',
                'sales_end_date'          => 'required_with:sales_start_date|date_format:U|after:sales_start_date',
            ];
        }

        return [
            'name'                   => 'required|string',
            'cost'                   => 'sometimes|numeric|greater_than:0',
